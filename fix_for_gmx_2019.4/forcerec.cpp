                   ...
                   real                              print_force)
{
    ...
    real rtab_ewald;
    if (fr->ic->cutoff_scheme == ecutsVERLET && fr->efep == efepNO)
    {
        rtab_ewald = fr->ic->rcoulomb;
    }
    else
    {
        rtab_ewald = ir->rlist + ir->tabext;
    }
    init_interaction_const_tables(fp, fr->ic, rtab_ewald);
